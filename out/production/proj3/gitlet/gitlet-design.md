    ...
    **Yu Xi Gui**
    Classes and Data Structures
      ...
      Stage: The class that performs the staging process.
        ...
        3.HashMap<String, String> currentCommit:files in the current commit.
    ...
    Main:
        ...
        4.rm:This unstages the file if it is currently stages for add.
        ...
        8.status:this displays what branches currently exist and mark the current branch with a *.
        9.checkout:This basically overwrites the current file with the given.
